...
public class RainbowTable2 {
	...
	//Costruttore
	public RainbowTable2(String charset, int pwdLength, int chainLength, int numChains, String hashAlgorithm, String salt) {
    ...
    public String getDigest(String inputString) throws NoSuchAlgorithmException { //preso da DdigitalSignature project
        ...
        byte[] bytes = md.digest((inputString + salt).getBytes(StandardCharsets.UTF_8)); //Garantisce compatibilità cross-platform
